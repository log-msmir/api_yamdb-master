...
#TODO отрефакторить это безобразие
    ...
    def setUp(self) -> None:
        self.user = User.objects.create(email='user@mail.ru', username='user', role='user')
        self.moderator = User.objects.create(email='moderator@mail.ru', username='moderator', role='moderator')
        self.admin = User.objects.create(email='admin@mail.ru', username='admin', role='admin')
    ...
    def registraton(self):
        ...
        request_user = client_user.post(reverse('auth_email'), data={'email': self.user.email})
        ...
        request_user = client_user.post(reverse('auth_token'), data={'email': self.user.email,
                                           'confirmation_code': confirmation_code_user })
        self.token_user = 'Bearer ' + request_user.data.get('token')
        
        
        client_moderator = APIClient()
        request_moderator = client_moderator.post(reverse('auth_email'), data={'email': self.moderator.email})
        ...
        request_moderator = client_moderator.post(reverse('auth_token'), data={'email': self.moderator.email,
        ...
        request_admin = client_admin.post(reverse('auth_email'), data={'email': self.admin.email})
        ...
        request_admin = client_admin.post(reverse('auth_token'),data={'email': self.admin.email,
